...
<head>
    ...
    <title>Reset Password - Mondial Bakery</title>
    ...
    <div class="login-container">
        ...
        <div class="login-right">
            <div class="login-box">
                ...
                <form method="POST" action="{{ route('password.update') }}" id="resetPasswordForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="nama@email.com" value="{{ old('email', $email ?? '') }}" {{ !empty($email) ? 'readonly' : '' }} required autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <p class="register-link">Ingat password? <a href="{{ route('login') }}">Masuk Sekarang</a></p>
            </div>
        </div>
    </div>
    <script>
