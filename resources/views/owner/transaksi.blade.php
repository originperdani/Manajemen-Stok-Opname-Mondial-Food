...
<div class="card mb-4" style="border-radius: 16px; border: 1px solid var(--border); background: #fff; border-left: 5px solid var(--primary);">
    <div class="card-body" style="padding: 1.5rem;">
        <form method="GET" action="{{ route('owner.transaksi') }}" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
            ...
            <div class="form-group mb-0" style="margin-left: auto;">
                ...
                <div class="d-flex gap-1" style="flex: 1; flex-wrap: wrap">
                    ...
                    <a href="{{ route('owner.transaksi') }}" class="btn btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.875rem; height: 42px; display: flex; align-items: center;">Reset</a>
                </div>
            </div>
        </form>
    </div>
...
<div class="card" style="border-left: 5px solid var(--primary);"><div class="table-responsive"><table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="{{ route('owner.transaksi.detail', $t) }}" class="btn btn-sm btn-secondary">Lihat</a></td>
        </tr>
        @endforeach
    </tbody>
</table></div></div>
